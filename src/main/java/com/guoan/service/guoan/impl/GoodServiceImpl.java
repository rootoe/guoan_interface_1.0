 ...
 */
@Service
public class GoodServiceImpl extends RedisService implements ShopGoodService {
    ...
    public Result index(String jsonString) {
        ...
        if(0 != area){
            ...
            shopGoodsTypeCriteria.createCriteria().andStoreIdEqualTo((Long) storeId).andProductSaletypeEqualTo(paramsJson.getString("productSaleType"));;
        } else {
            shopGoodsTypeCriteria.createCriteria().andProductSaletypeEqualTo(paramsJson.getString("productSaleType"));;
        }
        ...
        for (ShopGoodsType shopGoodsType : shopGoodsTypeList){
            ...
            if(!ListUtils.isEmpty(shopGoodsList)){
                ...
                shopGoodsTypeJSONObject.put("productSalesType", shopGoodsType.getProductSaletype());
