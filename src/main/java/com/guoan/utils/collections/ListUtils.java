 ...
 * @Description: 列表List工具类，用于实现一些list的常用操作
 * @author 赵彤
 * @date 2013-10-10 下午05:25:07
 * @version V1.0
 */
public class ListUtils {
	 ...
	 * @param sourceList
	 * @param entry
	 * @return 若entry在sourceList已经存在，返回false；否则新增并返回true
	 *         注意此函数不能保证源sourceList中元素不重复。
	 */
	 ...
	 *         <li>{@link java.util.List#add(Object)} 异常返回false</li>
	 *         <li>以上皆不满足，返回true</li>
	 *         </ul>
	 */
	...
	/**
	 * 参考{@link ArrayUtils#getLast(Object[], Object, Object, boolean)}
	 * defaultValue为null, isCircle为true
	 */
	...
	/**
	 * 参考{@link ArrayUtils#getNext(Object[], Object, Object, boolean)}
	 * defaultValue为null, isCircle为true
	 */
	@SuppressWarnings("unchecked")
