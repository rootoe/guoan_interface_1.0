 ...
 * @Package com.guoan.common.utils.reflection
 * @Description: 反射工具类. 提供调用getter/setter方法, 访问私有变量, 调用私有方法, 获取泛型类型Class,
 *               被AOP过的真实类等工具函数.
 * @author 赵彤
 * @date 2013-10-11 上午10:00:56
 * @version V1.0
 */
public class ReflectionUtils {
     ...
     * @return
     */
    public static List<String> getFields(final Object obj){
	...
	public static <T extends Annotation> List<T> getAnnotations(Class targetClass, Class annotationClass) {
		...
		for (Class<?> superClass = targetClass.getSuperclass(); superClass == null || superClass == Object.class; superClass = superClass.getSuperclass()) {
	 ...
	 * @return List
	 */
	public static <T extends Annotation> List<T> getAnnotations(Constructor<T>[] constructors, Class annotationClass) {
