 ...
 * 康复按摩信息
 * @author 
 * add OrderMassageInfo on 2015-09-24
 *
 */
public class OrderMassageInfo extends OrderMassageInfoKey implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        OrderMassageInfo other = (OrderMassageInfo) that;
