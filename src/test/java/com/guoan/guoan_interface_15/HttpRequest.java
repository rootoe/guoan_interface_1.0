...
public class HttpRequest {
    ...
    // 生成图片函数
    public static void downloadImage(String imgUrl, String fileURL, String code) {
        try {
        ...
        try {
            ...
            if (file.isFile() && file.exists()) { //判断文件是否存在
                ...
                while ((lineTxt = bufferedReader.readLine()) != null) {
                    System.out.println("现在执行到这个 -> " + lineTxt);
                    String code = lineTxt;
                    //发送 GET 请求
                    String s = HttpRequest.sendGet("http://qrk.kuaipai.cn/loganal/base/scan/show-json-advert.action", "code=" + code);
                    ...
                    if (StringUtils.isNotEmpty(s)) {
                        ...
                        try {
                            ...
                            if (StringUtils.isNotEmpty(img)) {
                                HttpRequest.downloadImage(img, "D:\\test\\", code);
                            }
                            System.out.println(s);
                        }catch (JSONException jsonException){
                            System.out.println("没有关键词 -> " +jsonException);
                        }
                    }
                }
                read.close();
